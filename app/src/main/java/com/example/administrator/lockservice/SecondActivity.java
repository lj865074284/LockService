...
public class SecondActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ArrayAdapter<>(this, android.R.layout.simple_expandable_list_item_1, listData);
    ...
    public void onResult(String result) {
        ...
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                String data = "网络请求成功:  " + new SimpleDateFormat("yyyy-MM-dd:HH:mm:ss").format(new Date())
                        + ":===========>" + (listData.size() + 1);
